    ...
    $(go.GraphLinksModel,
      {
        ...
        nodeDataArray: [
          { key: "Record1",
            widths: [ NaN, NaN, 60 ],
            fields: [
              { name: "field1", info: "first field", color: "#F25022", figure: "Ellipse" },
              { name: "field2", info: "the second one", color: "#F25022", figure: "LineH" },
              { name: "fieldThree", info: "3rd", color: "#00BCF2", figure: "LineH" }
            ],
            loc: "0 0" },
          { key: "Record2",
            widths: [NaN, NaN, NaN],
            fields: [
              { name: "fieldA", info: "",       color: "#F25022", figure: "Ellipse" },
              { name: "fieldB", info: "",       color: "#F25022", figure: "LineH" },
              { name: "fieldC", info: "",       color: "#7FBA00", figure: "LineH" },
              { name: "fieldD", info: "fourth", color: "#00BCF2",  figure: "LineH" }
            ],
            loc: "250 0" },
            ...
            widths: [NaN, NaN, NaN],
            fields: [
              { name: "fieldA1", info: "",       color: "#F25022", figure: "Ellipse" },
              { name: "fieldB2", info: "",       color: "#7FBA00", figure:"LineH" },
              { name: "fieldC3", info: "",       color: "#7FBA00", figure: "LineH" },
              { name: "fieldD4", info: "fourth", color: "#00BCF2",  figure: "LineH" }
            ]
          }
        ],
        linkDataArray: [
